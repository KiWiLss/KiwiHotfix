...
public class AppBarLayoutOverScrollViewBehavior1 extends AppBarLayout.Behavior {

    public AppBarLayoutOverScrollViewBehavior1() {
    }

    public AppBarLayoutOverScrollViewBehavior1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
