...
//                        .setAction("Action", null).show();
        ...
        drawer.addDrawerListener(new DrawerLayout.DrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                //Log.e("MMM", "onDrawerSlide: "+slideOffset);

                //drawer.setTranslationX();
                //Log.e("MMM", "onDrawerSlide: "+navigationView.getWidth());
                mOuter.setTranslationX(slideOffset*navigationView.getWidth());
                //navigationView.setTranslationX(1*navigationView.getWidth());
