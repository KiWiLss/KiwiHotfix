package com.winding.kiwihotfix.widget;
...
public class DribSearchView extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    public DribSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //TypedArray ta = context.obtainStyledAttributes(attrs, new int[]{R.styleable.DribSearchView_breadth}, defStyleAttr, 0);


        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SearchView);
        mBreadth = a.getInteger(R.styleable.SearchView_breadth, 2);
        mSearchColor = a.getColor(R.styleable.SearchView_search_color, Color.WHITE);
        a.recycle();
        initView();
    }
