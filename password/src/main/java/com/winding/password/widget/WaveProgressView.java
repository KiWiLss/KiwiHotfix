package com.winding.password.widget;
...
import com.winding.password.utils.DpOrPxUtils;
...
public class WaveProgressView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        secondWaveColor = typedArray.getColor(R.styleable.WaveProgressView_second_wave_color,getResources().getColor(R.color.colorAccent));
